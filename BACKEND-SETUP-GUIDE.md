...
**Aluta backend** — Node.js/Express API for subscription and payment management on Hedera testnet. See [README.md](README.md) for project overview, [demo](https://glittery-alpaca-76b271.netlify.app/), and [demo video](https://youtu.be/xI_zSQ7vCgM).
...
Create `.env` file in `/backend` with required variables (see [backend/ENVIRONMENT_SETUP.md](backend/ENVIRONMENT_SETUP.md) for full list):
```env
PORT=5000
